EADME.md: É um arquivo de documentação em Markdown que explica um projeto de software. Geralmente contém uma descrição do projeto, instruções de instalação e uso, e outras informações úteis.
